...
class GuarderiaLista extends Component {
    ...
    render() {
        ...
        return (
            <>
                <button id="boton-Guarderia" className="btn btn-success" onClick={() => {
                    this.setState({
                        form: null,
                        tipoModal: 'insertar'
                    });
                    this.modalInsertar()
                }}>Agregar Registro de Guarderia</button>
                    ...
                    <table class="table">
                        <thead id="tabla1">
                            <tr>
                                ...
                                <th id="texto1">fecha de Ingreso</th>
                                <th id="texto1">Cantidad de días</th>
                                <th id="texto1">Dirección</th>
                            ...
                            {this.state.data.map((val) => {
                                return (
                                    <tr id="tabla">
                                        ...
                                        <td id="texto">{val.fechaIngreso}</td>
                                        <td id="texto">{val.cantidadDias}</td>
                ...
                <Modal isOpen={this.state.modalInsertar}>
                    <ModalHeader id="modal-cuerpo" style={{ display: 'block' }}>
                        <h3 id="texto2">Agregar Registro</h3>
                    ...
                    <ModalBody id="modal-cuerpo"> 
                        <div className="form-group">
                            ...
                            <br />
                            <label id="texto4">Fecha de Ingreso:</label>
                            ...
                            <br />
                            <label id="texto4">Cantidad de Días:</label>
                            <input className="form-control" type="text" name="cantidadDias" id="cantidadDias" onChange={this.handleChange} value={form ? form.cantidadDias : ''} />
                            <br />
